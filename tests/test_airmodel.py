"""Tests for airmodel — async ORM for Pydantic models and PostgreSQL.
...
class TestMultipleObjectsReturned:
    ...
    def test_importable_from_airmodel(self) -> None:
        # Already imported at top: from airmodel import MultipleObjectsReturned
        assert issubclass(MultipleObjectsReturned, Exception)
...
class TestAirModelExport:
    """from airmodel import AirModel gives you the full ORM base class."""
