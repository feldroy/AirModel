...
class TestTableNameWithPrefix:
    def test_model_table_name_is_prefixed(self) -> None:
        ...
        # Module is "test_table_prefix" (standalone file, not generic)
        assert SampleWidget._table_name() == "test_table_prefix_sample_widget"
    ...
    def test_create_table_sql_uses_prefixed_name(self) -> None:
        ...
        assert '"test_table_prefix_gadget_item"' in sql
